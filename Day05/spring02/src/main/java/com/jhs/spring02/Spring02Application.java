...
public class Spring02Application {
	...
	public static void main(String[] args) throws IOException {
		...
		// PrintWriter - \n을 사용하지 않는 방식
		PrintWriter pw = new PrintWriter("C:/temp/pwtest.txt");
		...
		PrintWriter pw2 = new PrintWriter(new FileWriter("C:/temp/pwtest.txt", true));
		...
		// FileInputStream: 한 번에 전부를 읽어올 때, 대용량 문서는 읽다가 예외 발생
		...
		BufferedReader br = new BufferedReader(new FileReader("C:/temp/pwtest.txt"));
